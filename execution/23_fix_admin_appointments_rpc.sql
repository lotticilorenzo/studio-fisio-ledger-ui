-- FIX: Add operator_id to admin_get_appointments RPC
-- This is required for the "My Appointments" filter in the Admin Dashboard to work correctly.
-- We must DROP the function first because we are changing the return type.

DROP FUNCTION IF EXISTS admin_get_appointments(timestamptz, timestamptz);
